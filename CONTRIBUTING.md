...
3. Keep the Pet ID stable unless the change intentionally creates a separate Pet.
...
6. Tag the release with the exact directory version, for example `v1.1.0`.
